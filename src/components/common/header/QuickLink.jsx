  ...
  return (
    <div className="flex flex-1 items-center gap-3">
      ...
      <Link
        ...
        className="relative w-9 h-9 flex items-center justify-center rounded-full transition-all duration-200 hover:scale-110"
      >
        <Bell size={19} />
      ...
      <Link
        to="/app/wishlist"
        className="relative w-9 h-9 flex items-center justify-center rounded-full hover:scale-110 transition-all duration-200"
      >
        <Heart size={19} />

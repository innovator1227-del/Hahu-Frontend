...
const ChatPage = () => {
  ...
  return (
    <div
      className={`flex h-full overflow-hidden m-5 p-4 pb-12 rounded-xl border border-slate-300 bg-slate-100 transition-all duration-700 ease-in-out shadow-2xl

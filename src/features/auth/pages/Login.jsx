    ...
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600">Sign in to continue to HAHU MARKET, Ethiopia's trusted second-hand marketplace.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-3xl shadow-lg p-8 sm:p-10">
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            <button type="button" className="flex items-center justify-center py-2 px-4 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors">
          ...
          <p className="mt-8 text-center text-sm text-gray-600">
            Don&apos;t have an account? <Link to="/register" className="text-red-500 hover:text-red-600 font-medium">Sign up for free</Link>
          </p>
        </form>
      </div>
    </div>

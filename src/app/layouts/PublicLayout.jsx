...
const PublicLayout = () => {
  ...
  return (
    <div className={`min-h-screen text-black`}>
      ...
      />
      <div
        className={`min-h-screen transition-[padding] duration-500 ease-in-out ${showSidebar ? "md:pl-64" : "md:pl-[88px]"}`}
      >
        ...
        {showHero && (
          <div className="container mx-auto px-4 py-8">
            ...
            <p className="max-w-2xl text-gray-600">
              Browse trusted second-hand items, post listings, and manage orders
              with a responsive market experience.
            </p>
          </div>
        )}
